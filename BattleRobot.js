...
exports.BattleRobot = void 0;
//const robot = require("./Robot.js");
const Robot_1 = require("./Robot");
const ivm = require("isolated-vm");
class BattleRobot extends Robot_1.Robot {
    constructor(baseRobot, id, teamId) {
...
Robot.fire = function() {
    ...
    runTick() {
        ...
        var strresult = this.runScript.runSync(this.context, { timeout: 1000 });
        if (strresult) {
...
exports.BattleRobot = BattleRobot;
//# sourceMappingURL=BattleRobot.js.map